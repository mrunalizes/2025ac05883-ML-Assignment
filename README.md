...
| kNN | Highest Precision but the lowest Recall — it is conservative about flagging disease, missing more true positive cases than other models. Performance is sensitive to feature scaling (handled here via `StandardScaler`) and the choice of k. |
